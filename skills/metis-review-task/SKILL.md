...
Run `${CLAUDE_PLUGIN_ROOT}/.metis/scripts/review-task-preflight.sh`. It exits non-zero if the working directory isn't a git repo. On success it reports two fields:
